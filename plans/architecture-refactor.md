...
- T-001 | Create `CharacterResponse` DTO and Mapper | AI Agent | complexity: S | deps: [] | done: false
- T-002 | Refactor `CharacterController` to return DTOs | AI Agent | complexity: S | deps: [T-001] | done: false
- T-003 | Configure Redis in `docker-compose.yml` | AI Agent | complexity: XS | deps: [] | done: false
- T-004 | Implement `StyleService` with `@Cacheable` | AI Agent | complexity: M | deps: [T-003] | done: false
