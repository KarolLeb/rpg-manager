...
public class ActionPolicyPersistenceAdapter implements ActionPolicyRepositoryPort {
    ...
    @Override
    public Optional<ActionPolicy> findByActionTypeAndContextTypeAndContextId(ActionType actionType,
            ContextType contextType, Long contextId) {
        return jpaRepository.findByActionTypeAndContextTypeAndContextId(actionType, contextType, contextId)
                .map(mapper::toDomain);
    }
}
