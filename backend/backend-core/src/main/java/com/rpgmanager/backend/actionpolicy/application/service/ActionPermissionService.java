  ...
  public boolean canPerformAction(
    ...
    if (sessionId != null) {
      Optional<CharacterActionOverride> sessionOverride =
          characterActionOverrideRepositoryPort
    ...
    if (campaignId != null) {
      Optional<CharacterActionOverride> campaignOverride =
          characterActionOverrideRepositoryPort
              .findByCharacterIdAndActionTypeAndContextTypeAndContextId(
    ...
    if (sessionId != null) {
      Optional<ActionPolicy> sessionPolicy =
          actionPolicyRepositoryPort.findByActionTypeAndContextTypeAndContextId(
    ...
    if (campaignId != null) {
      Optional<ActionPolicy> campaignPolicy =
          actionPolicyRepositoryPort.findByActionTypeAndContextTypeAndContextId(
