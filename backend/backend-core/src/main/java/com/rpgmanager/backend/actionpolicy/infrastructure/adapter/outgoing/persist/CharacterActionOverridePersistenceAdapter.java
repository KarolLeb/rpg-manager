...
public class CharacterActionOverridePersistenceAdapter
    implements CharacterActionOverrideRepositoryPort {
  ...
  @Override
  public Optional<CharacterActionOverride> findByCharacterIdAndActionTypeAndContextTypeAndContextId(
    ...
    return jpaRepository
        .findByCharacterIdAndActionTypeAndContextTypeAndContextId(
            characterId, actionType, contextType, contextId)
        .map(mapper::toDomain);
  }
}
