...
class ActivityEventListenerTest {
  ...
  void handleActivityEvent_shouldDelegateToActivityLogService() {
    ...
    org.mockito.ArgumentCaptor<CreateActivityLogRequest> captor = org.mockito.ArgumentCaptor
        .forClass(CreateActivityLogRequest.class);
    ...
    org.assertj.core.api.Assertions.assertThat(request.getDescription()).isEqualTo("Rolled d20, got 18");
    ...
    org.assertj.core.api.Assertions.assertThat(request.getMetadata()).containsEntry("sides", 20).containsEntry("result",
        18);
  }
