...
@AnalyzeClasses(packages = "com.rpgmanager", importOptions = { ImportOption.DoNotIncludeTests.class })
public class HexagonalArchitectureTest {
    ...
    @ArchTest
    public static final ArchRule domain_should_be_completely_isolated = classes()
            .that()
    ...
    @ArchTest
    public static final ArchRule application_should_not_depend_on_infrastructure = classes()
            .that()
