...
class ErrorLogControllerTest {
  ...
  @InjectMocks private ErrorLogController controller;
  ...
  void logError() {
    ...
    ErrorLogDto dto =
        new ErrorLogDto(
            1L, "service", ErrorLogEntry.Severity.CRITICAL, "msg", "trc", "cor", 2L, "path", null);
  ...
  void getErrors() {
    ErrorLogDto dto =
        new ErrorLogDto(
            1L, "service", ErrorLogEntry.Severity.CRITICAL, "msg", "trc", "cor", 2L, "path", null);
    when(errorLogService.getErrors(null, null, null, null))
