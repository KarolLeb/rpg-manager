...
> [!IMPORTANT]
> Before running end-to-end tests, ensure that the frontend service is not running in Docker (e.g., run `docker-compose down` in the `infra/app/` directory). Playwright is configured to start its own development server for testing.
